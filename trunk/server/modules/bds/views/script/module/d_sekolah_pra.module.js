/**
 * @class Bds.module.d_sekolah_pra
 * Module panel for table bds_d_sekolah_pra
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
Bds.module.d_sekolah_pra = Ext.extend(Webi.module.Panel, {
    addTitle: 'Tambah Pra-SD',
    editTitle: 'Edit Pra-SD',
    winWidth:597,
    winHeight:540,
    levelSekolah: 'PRA-SD',
    /**
    ...
    initComponent : function() {
        // super
        Bds.module.d_sekolah_pra.superclass.initComponent.call(this);
    },
    buildPanel : function(){
...
Ext.reg('module_d_sekolah_pra', Bds.module.d_sekolah_pra);