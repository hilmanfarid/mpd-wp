...
class t_armada_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'armada_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $armada_id = wbRequest::getVarClean('armada_id', 'int', 0);
		$trayek_id = wbRequest::getVarClean('trayek_id', 'int', 0);
		$armada_tahun = wbRequest::getVarClean('armada_tahun', 'int', 0);
		$armada_jml_angkot = wbRequest::getVarClean('armada_jml_angkot', 'int', 0);
		$armada_jml_biskota = wbRequest::getVarClean('armada_jml_biskota', 'int', 0);
		$armada_jml_lain = wbRequest::getVarClean('armada_jml_lain', 'int', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_armada');
