/**
 * @class Bds.module.d_sekolah_sd
 * Module panel for table bds_d_sekolah_sd
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
Bds.module.d_sekolah_sd = Ext.extend(Webi.module.Panel, {
    addTitle: 'Tambah SD',
    editTitle: 'Edit SD',
    winWidth:597,
    winHeight:520,
    ...
    initComponent : function() {
        // super
        Bds.module.d_sekolah_sd.superclass.initComponent.call(this);
    },
    buildPanel : function(){
...
Ext.reg('module_d_sekolah_sd', Bds.module.d_sekolah_sd);