    ...
    buildForm : function() {
        ...
        this.on('loadrecord', function(form, record, actionType){
            if (actionType == 'update'){
                this.fields.comboBranch.getStore().load({params: {merchan_id:record.get('user_branch_id')}});
            }else{
                delete this.fields.comboBranch.lastQuery;
                this.fields.comboBranch.doQuery('', true);
            }            
        }, this);
        ...
        this.fields.comboBranch = new Bds.combo.branch({fieldLabel: 'Cabang', name: 'user_branch_id', allowBlank: true});
        return [
            this.fields.user_id,
