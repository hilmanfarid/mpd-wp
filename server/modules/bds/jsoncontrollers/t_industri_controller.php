...
class t_industri_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'industri_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $industri_id = wbRequest::getVarClean('industri_id', 'int', 0);
		$type_id = wbRequest::getVarClean('param_id', 'int', 0);
		$industri_tahun = wbRequest::getVarClean('industri_tahun', 'int', 0);
		$industri_jml_unit = wbRequest::getVarClean('industri_jml_unit', 'int', 0);
		$industri_peg_pria = wbRequest::getVarClean('industri_peg_pria', 'int', 0);
		$industri_peg_wanita = wbRequest::getVarClean('industri_peg_wanita', 'int', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_industri');
    ...
    public static function upload_excel($args = array()){
        ...
        try {
            ...
            foreach($items as $rec) {
                $errorMessage .= $table->cekValid(trim($rec['param_name']), $rec['industri_tahun']);             
            }
