 ...
 * @author hilman farid
 */
class t_vat_settlement extends AbstractTable{
    /* Table name */
    public $table = 't_vat_settlement';
    /* Alias for table */
    public $alias = 'settlement';
    /* List of table fields */
    public $fields = array(
                           't_vat_setllement_id' => array('type' => 'int', 'nullable' => false, 'unique' => true, 'display' => 't_vat_settlement_id'),
                           't_customer_order_id' => array('type' => 'int', 'nullable' => false, 'unique' => true, 'display' => 't_customer_order_id'),
    ...
    /* Display fields */
    public $displayFields = array('settlement.t_vat_setllement_id');
    /* Details table */
