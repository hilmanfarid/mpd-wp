 ...
 * @author hilman farid
 */
class t_trans_histories extends AbstractTable{
    /* Table name */
    ...
    public $selectClause = "select nvl(nama,company_name)as new_company_name, masa_awal, masa_akhir,data_transaksi.* ";

    public $fromClause = "from (select *
                        	from 
                        		(select c.npwd, 
