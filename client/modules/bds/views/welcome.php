        <script type="text/javascript" src="lib/bootstrap/js/jquery-1.9.1.min.js"></script>
        <script type="text/javascript" src="lib/bootstrap/js/jssor.slider.mini.js"></script>
...
<div align="center" style="margin:5 5 5 5;">
    ...
    <style>
        ...
        */
        .jssora02l, .jssora02r {
            ...
            height: 55px;
            cursor: pointer;
            background: url('images/slider/a02.png') no-repeat;
            overflow: hidden;
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-sm-3 col-md-3 col-xs-11" style = "padding: 0px;">
                <!-- small box -->
                <div class="small-box bg-aqua" style="width:500;">
                    <div class="inner">
                        <div>
                            <img src="images/happy.gif" style="height: 90px;"/>
                        </div>
                        <p>
                    ...
                    <div id='coba-klik-disini' onclick="getModuleExt('t_vat_settlement');" class="small-box-footer"style="font-size: 17px;cursor:pointer;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div id="jssor_1" style="width: 600px; height: 300px; overflow: hidden; visibility: hidden;">
                    <!-- Loading Screen -->
