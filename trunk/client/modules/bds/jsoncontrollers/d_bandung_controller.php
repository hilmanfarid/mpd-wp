...
class d_bandung_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
					...
					'controller' => json_encode(array('module' => 'bds','class' => 'd_bandung', 'method' => 'read', 'type' => 'json' )),
    ...
    public static function create($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'd_bandung', 'method' => 'create', 'type' => 'json' )),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
    ...
    public static function update($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'd_bandung', 'method' => 'update', 'type' => 'json' )),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
    ...
    public static function destroy($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'd_bandung', 'method' => 'destroy', 'type' => 'json')),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
