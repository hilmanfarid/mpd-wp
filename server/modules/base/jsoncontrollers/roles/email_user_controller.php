...
/**
 * email_user
 * class controller for table core_email_user 
 *
 * @since 22-01-2010 13:23:17
 * @author agung.hp
 */
class email_user_controller extends wbController{    
    ...
    public static function read($args = array()){
        // Security check
        wbSecurity::check('email_user', ACCESS_READ);
    ...
    public static function create($args = array()){
        // Security check
        wbSecurity::check('email_user', ACCESS_ADD);
    ...
    public static function update($args = array()){
        // Security check
        wbSecurity::check('email_user', ACCESS_EDIT);
    ...
    public static function destroy($args = array()){
        // Security check
        wbSecurity::check('email_user', ACCESS_DELETE);
