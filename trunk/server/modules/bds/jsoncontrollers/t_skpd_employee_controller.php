...
/**
 * t_skpd_employee
 * class controller for table bds_t_skpd_employee 
 *
 * @since 13-12-2012 14:15:12
 * @author agung.hp
 */
class t_skpd_employee_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('TSkpdEmployee')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 't_skpd_employee_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $t_skpd_employee_id = wbRequest::getVarClean('t_skpd_employee_id', 'int', 0);
		$d_skpd_id = wbRequest::getVarClean('d_skpd_id', 'int', 0);
		$tahun = wbRequest::getVarClean('tahun', 'int', 0);
		$jml_peg_organik = wbRequest::getVarClean('jml_peg_organik', 'float', 0);
		$jml_peg_non_organik = wbRequest::getVarClean('jml_peg_non_organik', 'float', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_skpd_employee');
