...
class t_modern_mart_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'mmart_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $mmart_id = wbRequest::getVarClean('mmart_id', 'int', 0);
		$type_id = wbRequest::getVarClean('param_id', 'int', 0);
		$mmart_tahun = wbRequest::getVarClean('mmart_tahun', 'int', 0);
		$mmart_jml_unit = wbRequest::getVarClean('mmart_jml_unit', 'int', 0);
		$mmart_jml_peg_pria = wbRequest::getVarClean('mmart_jml_peg_pria', 'int', 0);
		$mmart_jml_peg_wanita = wbRequest::getVarClean('mmart_jml_peg_wanita', 'int', 0);
