...
/**
 * t_agr_komod_prod
 * class controller for table bds_t_agr_komod_prod 
 *
 * @since 13-12-2012 16:29:27
 * @author agung.hp
 */
class t_agr_komod_prod_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('TAgrKomodProd')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 't_agr_komod_prod_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $t_agr_komod_prod_id = wbRequest::getVarClean('t_agr_komod_prod_id', 'int', 0);
		$d_agr_komiditas_id = wbRequest::getVarClean('d_agr_komiditas_id', 'int', 0);
		$tahun = wbRequest::getVarClean('tahun', 'int', 0);
		$luas_tanam = wbRequest::getVarClean('luas_tanam', 'float', 0);
		$luas_panen = wbRequest::getVarClean('luas_panen', 'float', 0);
		$productivity = wbRequest::getVarClean('productivity', 'float', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_agr_komod_prod');
