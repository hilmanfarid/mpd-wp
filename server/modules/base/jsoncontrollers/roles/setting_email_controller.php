...
/**
 * setting_email
 * class controller for table core_setting_email 
 *
 * @since 22-01-2010 13:23:17
 * @author agung.hp
 */
class setting_email_controller extends wbController{    
    ...
    public static function read($args = array()){
        // Security check
        wbSecurity::check('setting_email', ACCESS_READ);
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'setting_email_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $setting_email_id = wbRequest::getVarClean('setting_email_id', 'int', 0);
		$setting_email_module = wbRequest::getVarClean('setting_email_module', 'str', '');

        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('base', 'roles.setting_email');
    ...
    public static function create($args = array()){
        // Security check
        wbSecurity::check('setting_email', ACCESS_ADD);
    ...
    public static function update($args = array()){
        // Security check
        wbSecurity::check('setting_email', ACCESS_EDIT);
    ...
    public static function destroy($args = array()){
        // Security check
        wbSecurity::check('setting_email', ACCESS_DELETE);
