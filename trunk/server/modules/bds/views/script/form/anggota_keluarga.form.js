 ...
 * @author agung.hp
 */
Bds.form.anggota_keluarga = Ext.extend(Webi.form.FormPanel, {
    /**
     * initComponent
     * @protected
     */
    initComponent : function() {
        // super
        Bds.form.anggota_keluarga.superclass.initComponent.call(this);
    },
    ...
    buildForm : function() {
        ...
        this.fields.warga_pid = new Ext.form.Hidden({fieldLabel: Bds.properties.warga_pid, name: 'warga_pid', allowBlank: true});
        ...
        this.fields.hubkel_id = new Bds.combo.p_parameter({fieldLabel: Bds.properties.hubkel_id, name: 'hubkel_id', allowBlank: true, width:245});
        
        /* load record event */
        this.on('loadrecord', function(form, record, actionType){
            if (actionType == 'update'){
                this.fields.hubkel_id.store.baseParams.kode_type = 'HUBUNGAN KELUARGA';
                this.fields.hubkel_id.store.baseParams.extQuery = "p_parameter.param_code != '01'";
