...
/**
 * t_siswa
 * class controller for table bds_t_siswa 
 *
 * @since 02-11-2012 13:33:33
 * @author agung.hp
 */
class t_siswa_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('TSiswa')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 't_siswa_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $t_siswa_id = wbRequest::getVarClean('t_siswa_id', 'int', 0);
		$d_sekolah_id = wbRequest::getVarClean('d_sekolah_id', 'int', 0);
		$tahun = wbRequest::getVarClean('tahun', 'int', 0);
		$jml_masuk = wbRequest::getVarClean('jml_masuk', 'int', 0);
		$jml_lulus = wbRequest::getVarClean('jml_lulus', 'int', 0);
		$jml_aktif = wbRequest::getVarClean('jml_aktif', 'int', 0);
		$description = wbRequest::getVarClean('description', 'str', '');
		$creation_date = wbRequest::getVarClean('creation_date', 'str', '');
		$creation_by = wbRequest::getVarClean('creation_by', 'str', '');
		$updated_date = wbRequest::getVarClean('updated_date', 'str', '');
		$updated_by = wbRequest::getVarClean('updated_by', 'str', '');

        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('bds', 't_siswa');
