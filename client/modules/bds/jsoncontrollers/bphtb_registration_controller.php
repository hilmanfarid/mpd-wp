...
/**
 * bphtb_registration
 * class controller for table bds_bphtb_registration
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
class bphtb_registration_controller extends wbController{
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        //if (!wbSecurity::check('bphtb_registration')) return;
    ...
    public static function create($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'create', 'type' => 'json' )),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
    ...
    public static function update($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'update', 'type' => 'json' )),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
    ...
    public static function destroy($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
		    			'getParams' => json_encode($_GET),
		    			'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'destroy', 'type' => 'json')),
		    			'postParams' => json_encode($_POST),
		    			'jsonItems' => '',
		    			'start' => $start,
		    			'limit' => $limit);
    ...
    */
    public static function upload_excel($args = array()){
        ...
        try {
           ...
           $ws_client = self::getNusoap();
		   $params = array('search' => '',
					'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'upload_excel', 'type' => 'json' )),
    ...
    public static function execPembayaran($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
					'getParams' => json_encode($_GET),
					'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'execPembayaran', 'type' => 'json' )),
					'postParams' => json_encode($_POST),
					'jsonItems' => '',
					'start' => $start,
					'limit' => $limit);
    ...
    public static function cancelPembayaran($args = array()){
        ...
        try{
		    ...
		    $params = array('search' => '',
					'getParams' => json_encode($_GET),
					'controller' => json_encode(array('module' => 'bds','class' => 'bphtb_registration', 'method' => 'cancelPembayaran', 'type' => 'json' )),
					'postParams' => json_encode($_POST),
					'jsonItems' => '',
					'start' => $start,
					'limit' => $limit);
