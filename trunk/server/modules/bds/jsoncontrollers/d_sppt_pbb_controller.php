...
/**
 * d_sppt_pbb
 * class controller for table bds_d_sppt_pbb 
 *
 * @since 14-12-2012 01:58:19
 * @author agung.hp
 */
class d_sppt_pbb_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('DSpptPbb')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'sppt_pbb_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $sppt_pbb_id = wbRequest::getVarClean('sppt_pbb_id', 'int', 0);
		$kecamatan_id = wbRequest::getVarClean('wilayah_id', 'int', 0);
		$sppt_pbb_tahun = wbRequest::getVarClean('sppt_pbb_tahun', 'int', 0);
		$sppt_pbb_buah = wbRequest::getVarClean('sppt_pbb_buah', 'float', 0);
		$sppt_pbb_terhutang = wbRequest::getVarClean('sppt_pbb_terhutang', 'float', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 'd_sppt_pbb');
