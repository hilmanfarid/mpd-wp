 ...
 * @author hilman farid
 */
class p_sub_region extends AbstractTable{
    /* Table name */
    public $table = 'p_region';
    /* Alias for table */
    public $alias = 'sub_region';
    /* List of table fields */
    public $fields = array(
                           'p_region_id' => array('type' => 'int', 'nullable' => true, 'unique' => false, 'display' => 'p_region_id'),
    ...
    /* Display fields */
    public $displayFields = array('region_name');
    /* Details table */
    ...
    public $fromClause = "FROM sikp.p_region";
