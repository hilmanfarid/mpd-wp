...
/**
 * d_pdpt_daerah
 * class controller for table bds_d_pdpt_daerah 
 *
 * @since 14-12-2012 01:58:19
 * @author agung.hp
 */
class d_pdpt_daerah_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('DPdptDaerah')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'pdpt_daerah_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $pdpt_daerah_id = wbRequest::getVarClean('pdpt_daerah_id', 'int', 0);
		$jenis_id = wbRequest::getVarClean('param_id', 'int', 0);
		$pdpt_daerah_tahun = wbRequest::getVarClean('pdpt_daerah_tahun', 'int', 0);
		$pdpt_daerah_target = wbRequest::getVarClean('pdpt_daerah_target', 'float', 0);
		$pdpt_daerah_realisasi = wbRequest::getVarClean('pdpt_daerah_realisasi', 'float', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 'd_pdpt_daerah');
