...
/**
 * branch
 * class controller for table bds_branch 
 *
 * @since 23-10-2012 12:07:20
 * @author hilman farid
 */
class branch_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'branch_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'ASC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $branch_id = wbRequest::getVarClean('branch_id', 'int', 0);
		$branch_name = wbRequest::getVarClean('branch_name', 'str', '');
        
        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('bds', 'branch');
