...
/**
 * t_cuaca
 * class controller for table bds_t_cuaca 
 *
 * @since 13-12-2012 14:15:12
 * @author agung.hp
 */
class t_cuaca_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('TCuaca')) return;
        ...
        $t_cuaca_id = wbRequest::getVarClean('t_cuaca_id', 'int', 0);
		$tahun = wbRequest::getVarClean('tahun', 'int', 0);
		$bulan = wbRequest::getVarClean('bulan', 'int', 0);
		$penguapan = wbRequest::getVarClean('penguapan', 'float', 0);
		$tekanan_udara = wbRequest::getVarClean('tekanan_udara', 'float', 0);
		$kelembaban = wbRequest::getVarClean('kelembaban', 'float', 0);
		$suhu_max = wbRequest::getVarClean('suhu_max', 'float', 0);
		$suhu_min = wbRequest::getVarClean('suhu_min', 'float', 0);
		$suhu_rata2 = wbRequest::getVarClean('suhu_rata2', 'float', 0);
		$curah_hujan = wbRequest::getVarClean('curah_hujan', 'float', 0);
		$hari_hujan = wbRequest::getVarClean('hari_hujan', 'float', 0);
		$prosen_sinar = wbRequest::getVarClean('prosen_sinar', 'float', 0);
		$angin_rata2 = wbRequest::getVarClean('angin_rata2', 'float', 0);
		$arah_rata2 = wbRequest::getVarClean('arah_rata2', 'float', 0);
		$angin_max = wbRequest::getVarClean('angin_max', 'float', 0);
		$arah_max = wbRequest::getVarClean('arah_max', 'int', 0);
