...
class t_ternak_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'ternak_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $ternak_id = wbRequest::getVarClean('ternak_id', 'int', 0);
		$type_id = wbRequest::getVarClean('param_id', 'int', 0);
		$ternak_tahun = wbRequest::getVarClean('ternak_tahun', 'int', 0);
		$ternak_populasi = wbRequest::getVarClean('ternak_populasi', 'float', 0);
		$ternak_jml_potong = wbRequest::getVarClean('ternak_jml_potong', 'float', 0);
		$ternak_produksi_daging = wbRequest::getVarClean('ternak_produksi_daging', 'float', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_ternak');
