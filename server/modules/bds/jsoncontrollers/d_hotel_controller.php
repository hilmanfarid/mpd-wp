...
/**
 * d_hotel
 * class controller for table bds_d_hotel 
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
class d_hotel_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        ...
        $d_hotel_d_hotel_id = wbRequest::getVarClean('d_hotel_id', 'int', 0);
		$code = wbRequest::getVarClean('code', 'str', '');
		$hotel_name = wbRequest::getVarClean('sekolah_name', 'str', '');
		$alias_name = wbRequest::getVarClean('alias_name', 'str', '');
        $kelas_id = wbRequest::getVarClean('kelas_id', 'int', 0);
		$kelas_code = wbRequest::getVarClean('kelas_code', 'str', '');
        $jml_kamar = wbRequest::getVarClean('jml_kamar', 'int', 0);
