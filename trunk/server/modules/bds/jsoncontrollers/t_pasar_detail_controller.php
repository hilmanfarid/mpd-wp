...
/**
 * t_pasar_detail
 * class controller for table bds_t_pasar_detail 
 *
 * @since 14-12-2012 01:58:19
 * @author agung.hp
 */
class t_pasar_detail_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('TPasarDetail')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'pasar_det_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $pasar_det_id = wbRequest::getVarClean('pasar_det_id', 'int', 0);
		$pasar_id = wbRequest::getVarClean('pasar_id', 'int', 0);
		$pasar_det_tahun = wbRequest::getVarClean('pasar_det_tahun', 'int', 0);
		$pasar_det_jml_ruang = wbRequest::getVarClean('pasar_det_jml_ruang', 'int', 0);
		$pasar_det_jml_pedagang_aktif = wbRequest::getVarClean('pasar_det_jml_pedagang_aktif', 'int', 0);
		$pasar_det_jml_pedagang_pasif = wbRequest::getVarClean('pasar_det_jml_pedagang_pasif', 'int', 0);
        ...
        try{
            $table =& wbModule::getModel('bds', 't_pasar_detail');
