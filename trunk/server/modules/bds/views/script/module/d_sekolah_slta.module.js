/**
 * @class Bds.module.d_sekolah_slta
 * Module panel for table bds_d_sekolah_slta
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
Bds.module.d_sekolah_slta = Ext.extend(Webi.module.Panel, {
    addTitle: 'Tambah SLTA',
    editTitle: 'Edit SLTA',
    winWidth:597,
    winHeight:520,
    levelSekolah: 'SLTA',
    ...
    initComponent : function() {
        // super
        Bds.module.d_sekolah_slta.superclass.initComponent.call(this);
    },
    buildPanel : function(){
...
Ext.reg('module_d_sekolah_slta', Bds.module.d_sekolah_slta);