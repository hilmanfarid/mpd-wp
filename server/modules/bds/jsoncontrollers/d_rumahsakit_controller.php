...
class d_rumahsakit_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'rs_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $rs_id = wbRequest::getVarClean('rs_id', 'int', 0);
		$jenis_id = wbRequest::getVarClean('jenis_id', 'int', 0);
		$rs_kode = wbRequest::getVarClean('rs_kode', 'str', '');
		$rs_name = wbRequest::getVarClean('rs_name', 'str', '');
		$rs_alamat1 = wbRequest::getVarClean('rs_alamat1', 'str', '');
		$rs_alamat2 = wbRequest::getVarClean('rs_alamat2', 'str', '');
		$rs_kode_pos = wbRequest::getVarClean('rs_kode_pos', 'str', '');
		$rs_phone = wbRequest::getVarClean('rs_phone', 'str', '');
		$rs_website = wbRequest::getVarClean('rs_website', 'str', '');
		$rs_listing_no = wbRequest::getVarClean('rs_listing_no', 'int', 0);
		$rs_description = wbRequest::getVarClean('rs_description', 'str', '');
		$rs_creation_date = wbRequest::getVarClean('rs_creation_date', 'date', '');
		$rs_created_by = wbRequest::getVarClean('rs_created_by', 'str', '');
		$rs_updated_date = wbRequest::getVarClean('rs_updated_date', 'date', '');
		$rs_updated_by = wbRequest::getVarClean('rs_updated_by', 'str', '');
		
		$searchRS = wbRequest::getVarClean('searchRS', 'str', '');

        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('bds', 'd_rumahsakit');
            ...
            if(!empty($searchRS)) {
                $table->setCriteria('(d_rumahsakit.rs_kode ILIKE ? OR d_rumahsakit.rs_name ILIKE ?)', array('%'.$searchRS.'%', '%'.$searchRS.'%'));    
            }
