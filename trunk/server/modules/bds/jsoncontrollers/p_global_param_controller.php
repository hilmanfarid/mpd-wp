...
/**
 * p_global_param
 * class controller for table bds_p_global_param 
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
class p_global_param_controller extends wbController{    
    /**
     * read
    ...
    public static function read($args = array()){
        // Security check
        if (!wbSecurity::check('PGlobalParam')) return;
        ...
        $sort = wbRequest::getVarClean('sort', 'str', 'gparam_id');
        $dir = wbRequest::getVarClean('dir', 'str', 'DESC');
        $query = wbRequest::getVarClean('query', 'str', '');
        
        $gparam_id = wbRequest::getVarClean('gparam_id', 'int', 0);
		$gtype_id = wbRequest::getVarClean('gtype_id', 'int', 0);
		$gparam_code = wbRequest::getVarClean('gparam_code', 'str', '');
		$gparam_value_1 = wbRequest::getVarClean('gparam_value_1', 'str', '');
		$gparam_type_1 = wbRequest::getVarClean('gparam_type_1', 'str', '');
		$gparam_is_range = wbRequest::getVarClean('gparam_is_range', 'str', '');
		$gparam_value_2 = wbRequest::getVarClean('gparam_value_2', 'str', '');
		$gparam_description = wbRequest::getVarClean('gparam_description', 'str', '');
		$gparam_creation_date = wbRequest::getVarClean('gparam_creation_date', 'date', '');
		$gparam_creation_by = wbRequest::getVarClean('gparam_creation_by', 'str', '');
		$gparam_updated_date = wbRequest::getVarClean('gparam_updated_date', 'date', '');
		$gparam_updated_by = wbRequest::getVarClean('gparam_updated_by', 'str', '');

        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('bds', 'p_global_param');
