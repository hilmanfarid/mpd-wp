...
/**
 * p_wilayah_person
 * class model for table bds_p_wilayah_person 
 *
 * @since 23-10-2012 12:07:20
 * @author wiliamdecosta@gmail.com
 */
class p_wilayah_person extends AbstractTable{
    /* Table name */
    public $table = 'bds_p_wilayah_person';
    /* Alias for table */
    public $alias = 'p_wilayah_person';
    /* List of table fields */
    public $fields = array('wp_id' => array('type' => 'int', 'nullable' => false, 'unique' => true, 'display' => 'ID Wilayah Person'),
    ...
    public $selectClause = "SELECT p_wilayah_person.*, to_char(p_wilayah_person.rsp_creation_date, 'yyyy-mm-dd') AS rsp_creation_date, 
                                    to_char(p_wilayah_person.rsp_updated_date, 'yyyy-mm-dd') AS rsp_updated_date,                                
    ...
    public $fromClause = 'FROM bds_p_wilayah_person AS p_wilayah_person
							LEFT JOIN bds_p_parameter AS p_parameter ON p_wilayah_person.param_id = p_parameter.param_id
							LEFT JOIN bds_p_job_position AS p_job_position ON p_wilayah_person.jobpos_id = p_job_position.jobpos_id
							LEFT JOIN bds_p_wilayah AS p_wilayah ON p_wilayah_person.wilayah_id = p_wilayah.wilayah_id';
