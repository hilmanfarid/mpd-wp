...
class p_school_type_controller extends wbController{    
    ...
    public static function read($args = array()){
        ...
        $p_school_type_id = wbRequest::getVarClean('p_school_type_id', 'int', 0);
		$p_school_level_id = wbRequest::getVarClean('p_school_level_id', 'int', 0);
		$p_school_type_code = wbRequest::getVarClean('code', 'str', '');
		$p_school_type_listing_no = wbRequest::getVarClean('listing_no', 'int', 0);
		$p_school_type_description = wbRequest::getVarClean('description', 'str', '');
		$p_school_type_creation_date = wbRequest::getVarClean('creation_date', 'date', '');
		$p_school_type_creation_by = wbRequest::getVarClean('creation_by', 'str', '');
		$p_school_type_updated_date = wbRequest::getVarClean('updated_date', 'date', '');
		$p_school_type_updated_by = wbRequest::getVarClean('updated_by', 'str', '');
        
        $levelKode = wbRequest::getVarClean('levelKode', 'str', 0);
        
        $data = array('items' => array(), 'total' => 0, 'success' => false, 'message' => '');
        try{
            $table =& wbModule::getModel('bds', 'p_school_type');
            ...
            if(!empty($levelKode)) {
                $table->setCriteria('p_school_level.code = ?', array($levelKode));       
            }
            
            if(!empty($p_school_level_id)) {
                $table->setCriteria('p_school_type.level_id = ?', array($p_school_level_id));       
            }
